package net.onelitefeather.blackhole.backend.connector.controller;

import net.onelitefeather.blackhole.backend.connector.ConnectorRegistrationEntity;
import net.onelitefeather.blackhole.backend.connector.ConnectorRegistrationRepository;
import net.onelitefeather.blackhole.backend.connector.ConnectorScopes;
import net.onelitefeather.blackhole.backend.connector.ConnectorStatus;
import net.onelitefeather.blackhole.backend.connector.EventSubscriptionEntity;
import net.onelitefeather.blackhole.backend.connector.EventSubscriptionRepository;
import net.onelitefeather.blackhole.backend.connector.InvalidWebhookUrlException;
import net.onelitefeather.blackhole.backend.connector.WebhookUrlValidator;
import net.onelitefeather.blackhole.backend.connector.dto.ConnectorRegistrationCreatedDTO;
import net.onelitefeather.blackhole.backend.connector.dto.ConnectorRegistrationDTO;
import net.onelitefeather.blackhole.backend.connector.dto.ConnectorRegistrationRequestDTO;
import net.onelitefeather.blackhole.backend.connector.dto.EventSubscriptionCreatedDTO;
import net.onelitefeather.blackhole.backend.connector.dto.EventSubscriptionDTO;
import net.onelitefeather.blackhole.backend.connector.dto.EventSubscriptionRequestDTO;
